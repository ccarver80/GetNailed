...
export default function About() {
  return (
    <div className=" bg-lime-200">
      ...
      <div className="lg:flex md:flex block shadow-purple-500 shadow-lg bg-slate-400 p-5 mx-3 mt-10 ">
      ...
      {/* ================================ Photo Gallery ======================================== */}
        <div className="flex shadow-purple-500 shadow-lg bg-slate-400 p-10 mt-10 mx-5 ">
      ...
      {/* ================================== Store =============================================== */}
        <div className="text-center h-screen bg-slate-400 mt-10 mx-5">
